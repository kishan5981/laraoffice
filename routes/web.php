...
// if( env('DB_DATABASE') == '' )
{
    Route::get('/debug-sentry', function () {
        throw new Exception('Test error for GlitchTip!');
    });
...
Route::group( [], function () {
    ...
    Route::get('/show-demo', [ 'uses' => 'Auth\LoginController@showDemo', 'as' => 'auth.show-demo' ]);
    ...
    Route::group(['middleware' => ['auth'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
        ...
        Route::get('/change-color/{type}/{value}', 'HomeController@changeColor')->name('change.color');
...
//         Route::get('credit_notes', 'Admin\CreditNotesController@index')->name('credit_notes.index');
// Route::get('credit_notes/create', 'Admin\CreditNotesController@create')->name('credit_notes.create');
// Route::post('credit_notes/store', 'Admin\CreditNotesController@store')->name('credit_notes.store');
// Route::get('credit_notes/show', 'Admin\CreditNotesController@show')->name('credit_notes.show');
        ...
        Route::get('/ajax-request', 'Admin\ContactsController@onMouseHowerActions')->name('ajax.request');
        ...
        Route::get('search', 'Admin\MegaSearchController@search')->name('mega-search');
        Route::post('get-details', 'Admin\MegaSearchController@getDetails')->name('get-mega-details');
        ...
        Route::get('/dashboard/widgets/add/{id?}', [ 'uses' => 'HomeController@dashboardWidgetsAdd', 'as' => 'home.dashboard-widgets.edit' ]);
        ...
        Route::delete('/dashboard-widgets/delete/{id}', ['uses' => 'HomeController@deleteWidget', 'as' => 'home.dashboard-widgets.destroy']);
