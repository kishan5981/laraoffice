...
$(function() {
    ...
    function removeWidget( widget_id )
    {
        $.ajax({
                method: 'POST',
                url: '<?php echo e(route('admin.home.dashboard-widgets-change-status')); ?>',
                data: {
                    _token: _token,
                    widget_id: widget_id
                }
...
</script><?php /**PATH C:\xampp\htdocs\laraoffice\resources\views/dashboard-parts/dashboard-scripts.blade.php ENDPATH**/ ?>