<h3 class="page-title"><?php echo app('translator')->get('global.contact-companies.title'); ?></h3>
<?php echo Form::open(['method' => 'POST', 'route' => ['admin.contact_companies.store'],'class'=>'formvalidation', 'id' => 'frmCompany']); ?>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <?php echo $__env->make('admin.contact_companies.form-fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
</div>
...
<?php echo Form::submit(trans('global.app_save'), ['class' => 'btn btn-danger wave-effect', 'id' => 'saveCompany']); ?>
...
<script type="text/javascript">
  $("#saveCompany").click(function(e){
            ...
            $.ajax({
                url: "<?php echo e(route('admin.contact_companies.store')); ?>",
                type:'POST',
...
<?php $__env->stopSection(); ?><?php /**PATH C:\xampp\htdocs\laraoffice\resources\views/admin/contact_companies/create-form.blade.php ENDPATH**/ ?>