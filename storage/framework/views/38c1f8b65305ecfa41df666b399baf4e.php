...
<div class="col-md-6">
	...
	<select name="<?php echo e($key); ?>[value]" class="form-control" data-toggle="tooltip"
		...
		<?php if( ! empty( $value->extra->options ) ): ?>
...
</div><?php /**PATH C:\xampp\htdocs\laraoffice\resources\views/admin/general_settings/sub-list-views/select-type.blade.php ENDPATH**/ ?>