...
<div role="tabpanel" class="tab-pane active" id="progress">
	<?php echo $__env->make('admin.client_projects.canvas.canvas-progress', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
<div role="tabpanel" class="tab-pane" id="circle">
	<?php echo $__env->make('admin.client_projects.canvas.canvas-circle', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
</div>
</div><?php /**PATH C:\xampp\htdocs\laraoffice\resources\views/admin/client_projects/canvas/canvas-default.blade.php ENDPATH**/ ?>