...
<div class="login-content installation-page" style="margin-top: 20px; background-color: #fafafa;">
		...
		<div class="logo text-center"><img src="<?php echo e(asset('images/logo2.png')); ?>" alt="LaraOffice" height="100" width="300"></div>
...
<a class="btn button btn-success btn-lg" href="<?php echo e(url('install-check-requiremetns')); ?>"><span style="font-family: lato; font-size: 21px;">Let’s go!</span></a>
...
<?php echo $__env->make('install.install-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laraoffice\resources\views/install/index.blade.php ENDPATH**/ ?>