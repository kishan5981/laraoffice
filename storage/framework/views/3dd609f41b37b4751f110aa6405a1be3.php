    ...
    <div class="panel-body">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group filter-group">
                ...
                <div class="col-md-2">
            <div class="form-group filter-group">
                <label for="email"><?php echo app('translator')->get('others.statistics.payment'); ?></label>
                <?php
                ...
                ?>
                <?php echo Form::select('paymentstatus', $paymentstatuses, old('paymentstatus'), ['class' => 'form-control select2',  'data-live-search' => 'true', 'data-show-subtext' => 'true', 'id' => 'paymentstatus']); ?>
            ...
            <div class="form-group filter-group">
                ...
                <div class="col-md-2">
            <div class="form-group filter-group">
                <label for="email"><?php echo app('translator')->get('others.statistics.customer'); ?></label>
               <?php   
                 $filtercustomers = \App\Models\Contact::whereHas("contact_type",
                   function ($query) {
                       $query->where('id', CUSTOMERS_TYPE);
                   })->get()->pluck('name', 'id')->prepend(trans('global.app_please_select'), '');
                 ?>

                <?php echo Form::select('customer', $filtercustomers, old('customer'), ['class' => 'form-control select2',  'data-live-search' => 'true', 'data-show-subtext' => 'true', 'id' => 'customer']); ?>
...
<?php $__env->stopSection(); ?><?php /**PATH C:\xampp\htdocs\laraoffice\resources\views/admin/invoices/filters.blade.php ENDPATH**/ ?>