<h3 class="page-title"><?php echo app('translator')->get('global.contact-groups.title'); ?></h3>
<?php echo Form::open(['method' => 'POST', 'route' => ['admin.contact_groups.store'],'class'=>'formvalidation', 'id' => 'frmContactGroup']); ?>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <?php echo $__env->make('admin.contact_groups.form-fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
</div>
...
<?php echo Form::submit(trans('global.app_save'), ['class' => 'btn btn-danger wave-effect', 'id' => 'saveContactGroup']); ?>
...
<script type="text/javascript">
  $("#saveContactGroup").click(function(e){
            ...
            $.ajax({
                url: "<?php echo e(route('admin.contact_groups.store')); ?>",
                type:'POST',
...
<?php $__env->stopSection(); ?><?php /**PATH C:\xampp\htdocs\laraoffice\resources\views/admin/contact_groups/create-form.blade.php ENDPATH**/ ?>