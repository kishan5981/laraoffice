...
<div class="login-content installation-page" >
		...
		<div class="logo text-center"><img src="<?php echo e(asset('images/logo3.png')); ?>" alt="Laraoffice" height="100" width="300"></div>
		...
		<?php echo Form::open(array('route' => ['install.project'], 'method' => 'POST', 'name'=>'registrationForm ', 'novalidate'=>'', 'class'=>"loginform", 'id'=>"install_form")); ?>
...
<a href="<?php echo e(route('install.index')); ?>" title="Instructions" class="btn button btn-info btn-lg buttn"><span style="font-family: lato; font-size: 21px;">Instructions</span></a>&nbsp;&nbsp;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('install.install-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laraoffice\resources\views/install/database-details.blade.php ENDPATH**/ ?>