...
@section('content')
    ...
    <p>
        ...
        <a href="{{ route('admin.home.dashboard-widgets-all') }}" class="btn btn-success"><i class="fa fa-list"></i>&nbsp;@lang('global.app_all')</a>
    </p>
    @endcan
    ...
    <div class="panel panel-default">
        ...
        <table class="table table-bordered table-striped ajaxTable @can('widget_delete_multi') @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">
                <thead>
                    <tr>
                    <th>S.No</th> <!-- Added S.No column header -->
                        ...
                        <th>@lang('global.dashboard-widgets.fields.role')</th>
...
@section('javascript') 
@include('dashboard-parts.widgets-scripts')    
@endsection