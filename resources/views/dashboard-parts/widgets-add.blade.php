	    ...
	    <div class="panel-body">
	        <div class="row">
	            ...
	            <div class="form-group">
	                ...
	                <div class="form-line">
	                {!! Form::text('title', old('title'), ['class' => 'form-control', 'placeholder' => 'Name', 'required' => '','readonly']) !!}
	            ...
	            <div class="form-group">
	                ...
	                {!! Form::text('slug', old('slug'), ['class' => 'form-control', 'placeholder' => trans('global.dashboard-widgets.fields.slug'), 'readonly']) !!}
	                <p class="help-block"></p>
	                @if($errors->has('slug'))
	                    <p class="help-block" >
	                        {{ $errors->first('slug') }}
