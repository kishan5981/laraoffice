...
<li role="presentation" class="{{$tabs['tasks_active']}}"><a href="{{route('admin.task_statuses.show', [ 'id' => $task_status->id, 'list' => 'tasks' ])}}" title="@lang('global.tasks.title')">@lang('global.tasks.title')</a></li>
</ul>
