                ...
                <div class="panel-body-dr">
                    <div class="row text-left quick-top-stats">
                        ...
                        <div class="col-lg-5ths col-md-5ths">
                         ...
                         <?php
                           $total_open_tasks = App\Models\Task::where('status_id', '=', 1)->count();
                        ...
                        <div class="col-lg-5ths col-md-5ths">
                           ...
                           <?php
                           $total_inprogress_tasks = App\Models\Task::where('status_id', '=', 2)->count();
                      ...
                      <div class="col-lg-5ths col-md-5ths">
                       ...
                       <?php
                           $total_completed_tasks = App\Models\Task::where('status_id', '=', 4)->count();
