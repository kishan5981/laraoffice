   ...
   <div class="col-xs-{{COLUMNS}}">
    ...
    <div class="col-xs-{{COLUMNS}}">
        ...
        <div class="col-xs-6">
            ...
            <div class="form-group">
            {!! Form::label('prevent_overdue_reminders', trans('global.invoices.fields.prevent-overdue-reminders').'*', ['class' => 'control-label']) !!}<br>
    ...
    <label class="btn btn-lg btn-primary active">
        ...
        <div class="col-xs-{{COLUMNS}}">
            ...
            ?>
            <div class="form-line">
            {!! Form::number('show_quantity_as', old('show_quantity_as', $show_quantity_as), ['class' => 'form-control', 'placeholder' => 'Show quantity as']) !!}
            <p class="help-block"></p>
        ...
        <div class="col-xs-{{COLUMNS}}">
            ...
            ?>
            {!! Form::number('invoice_no', old('invoice_no', $invoice_no), ['class' => 'form-control', 'placeholder' => 'Enter invoice number']) !!}
            <p class="help-block"></p>
