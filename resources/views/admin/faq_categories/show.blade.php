...
<li role="presentation" class="{{$tabs['faq_questions_active']}}"><a href="{{route('admin.faq_categories.show', [ 'id' => $faq_category->id, 'list' => 'faq_questions' ])}}" title="@lang('others.canvas.questions')">@lang('others.canvas.questions')</a></li>
</ul>
