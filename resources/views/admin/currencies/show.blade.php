...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" class="{{$tabs['recurring_invoices_active']}}"><a href="{{route('admin.currencies.show', [ 'currency_id' => $currency->id, 'list' => 'recurring_invoices' ])}}">@lang('global.recurring-invoices.title')</a></li>
    @endif
    @if( isPluginActive('purchase_order') )
    <li role="presentation" class="{{$tabs['purchase_orders_active']}}"><a href="{{route('admin.currencies.show', [ 'currency_id' => $currency->id, 'list' => 'purchase_orders' ])}}">@lang('global.purchase-orders.title')</a></li>
    @endif
    @if( isPluginActive('credit_note') )
    <li role="presentation" class="{{$tabs['credit_notes_active']}}"><a href="{{route('admin.currencies.show', [ 'currency_id' => $currency->id, 'list' => 'credit_notes' ])}}">@lang('global.credit_notes.title')</a></li>
    @endif
</ul>
