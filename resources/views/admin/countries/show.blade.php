...
<li role="presentation" class="{{$tabs['companies_active']}}"><a href="{{route('admin.countries.show', [ 'id'=> $country->id,'list'=>'companies' ])}}" title="@lang('global.contact-companies.title')">@lang('global.contact-companies.title')</a></li>
<li role="presentation" class="{{$tabs['contacts_active']}}"><a href="{{route('admin.countries.show', [  $country->id ,'list'=>'contacts'])}}" title="@lang('global.contacts.title')">@lang('global.contacts.title')</a></li>
</ul>
