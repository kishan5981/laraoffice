                ...
                <div id="invoices_total">
                    ...
                    <div class="col-lg-3 total-column">
                            <div class="panel_s">
                              ...
                              <?php
	                           $total_amount_purchase_orders = \App\Models\PurchaseOrder::sum('amount');
	                           ?>
                        ...
                        <div class="col-lg-3 total-column">
                            ...
                            <?php
	                          ...
	                          $total_paid_purchase_orders = \App\Models\PurchaseOrder::where('status', '=', 'Published')->where('paymentstatus', '=', 'paid')->sum('amount');
                        ...
                        <div class="col-lg-3 total-column">
                            <div class="panel_s">
                              ...
                              <?php
	                           ...
	                           $total_unpaid_purchase_orders = \App\Models\PurchaseOrder::where('status', '=', 'Published')->where('paymentstatus', '=', 'unpaid')->sum('amount');
                        ...
                        <div class="col-lg-3 total-column">
                            <div class="panel_s">
                                <div class="panel-body-dr">
                       			...
                       			$purchase_orders_overdue = \App\Models\PurchaseOrder::where('paymentstatus', '=', 'unpaid')->where('status', '=', 'Published')->whereBetween('order_due_date', [ $from, $to])->count();
                       			$purchase_orders_overdue_unpaid_amount = \App\Models\PurchaseOrder::where('paymentstatus', '=', 'unpaid')->where('status', '=', 'Published')->whereBetween('order_due_date', [ $from, $to])->sum('amount');
                    ...
                    <div class="row text-left quick-top-stats">
                        <div class="col-lg-5ths col-md-5ths">
                            <div class="row">
                                ...
                                <?php
                           $total_purchase_orders = \App\Models\PurchaseOrder::count();
                           ?>
                        ...
                        <?php
                          $total_published_purchase_orders = \App\Models\PurchaseOrder::where('status', '=', 'Published')->count();
                           $total_published_paid_purchase_orders = \App\Models\PurchaseOrder::where('status', '=', 'Published')->where('paymentstatus', '=', 'paid')->count();
                        ...
                        <div class="col-lg-5ths col-md-5ths">
                          ...
                          <?php	
                           ...
                           $total_published_unpaid_purchase_orders = \App\Models\PurchaseOrder::where('status', '=', 'Published')->where('paymentstatus', '=', 'unpaid')->count();
                   ...
                   <div class="crm-right-border-b1 crm-invoice-summaries-b1">
                       ...
                       <div class="box-foot">
                           ...
                           <div class="box-foot-left">
	                        ...
	                        $total_paid_purchase_orders = \App\Models\PurchaseOrder::where('status', '=', 'Published')->where('paymentstatus', '=', 'paid')->count();
                     ...
                     <div class="crm-right-border-b1 crm-invoice-summaries-b1">
                       ...
                       <div class="box-foot">
                           ...
                           <div class="box-foot-left">
	                           ...
	                           $total_unpaid_purchase_orders = \App\Models\PurchaseOrder::where('status', '=', 'Published')->where('paymentstatus', '=', 'unpaid')->count();
