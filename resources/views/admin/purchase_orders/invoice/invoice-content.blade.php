   ...
   .address-ads{
        ...
        <article>
            <table class="balance">
                ...
                <tr>
                 ...
                 <?php
                    $total_paid = \App\Models\PurchaseOrderPayment::where('purchase_order_id', '=', $invoice->id)->where('payment_status', 'Success')->sum('amount');
    ...
    @if ( 'Yes' === $enable_signature_part )
            ...
            @endif
                 ...
                 <?php
            $payment = \App\Models\PurchaseOrderPayment::where('purchase_order_id', '=', $invoice->id)->orderBy('id', 'desc')->first();
