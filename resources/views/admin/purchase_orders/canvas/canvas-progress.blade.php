         ...
         <div class="col-lg-3 total-column">
            <div class="panel_s">
               <div class="panel-body-dr" onclick="summarypaymentstatus('all', 'all', 'progress', {{$currency_id}})">
                  <?php
                     $total_amount_purchase_orders = \App\Models\PurchaseOrder::where('currency_id', '=', $currency_id)->sum('amount');
                     ?>
         ...
         <div class="col-lg-3 total-column">
            <div class="panel_s">
               <div class="panel-body-dr" onclick="summarypaymentstatus('paymentstatus', 'paid', 'progress', {{$currency_id}})">
                  <?php
                     $total_paid_purchase_orders = \App\Models\PurchaseOrder::where('currency_id', '=', $currency_id)->where('status', '=', 'Published')->where('paymentstatus', '=', 'paid')->sum('amount');
         ...
         <div class="col-lg-3 total-column">
            <div class="panel_s">
               <div class="panel-body-dr" onclick="summarypaymentstatus('paymentstatus', 'unpaid', 'progress', {{$currency_id}})">
                  ...
                  <?php
                     $total_unpaid_purchase_orders = \App\Models\PurchaseOrder:: where('currency_id', '=', $currency_id)->whereIn('paymentstatus', array( 'unpaid', 'Unpaid', 'due' ) )->where('status', '=', 'Published')->whereRaw('order_due_date >= DATE(NOW())' )->sum('amount');
            ...
            <div class="panel_s">
               <div class="panel-body-dr" onclick="summarypaymentstatus('paymentstatus', 'overdue', 'progress', {{$currency_id}})">
                  <?php
                     ...
                     /*$purchase_orders_overdue = \App\Models\PurchaseOrder::where('currency_id', '=', $currency_id)->where('paymentstatus', '=', 'unpaid')->where('status', '=', 'Published')->whereBetween('order_due_date', [ $from, $to])->count();
                     $purchase_orders_overdue_unpaid_amount = \App\Models\PurchaseOrder::where('currency_id', '=', $currency_id)->where('paymentstatus', '=', 'unpaid')->where('status', '=', 'Published')->whereBetween('order_due_date', [ $from, $to])->sum('amount');*/
                     
                           $purchase_orders_overdue = \App\Models\PurchaseOrder::where('currency_id', '=', $currency_id)->whereIn('paymentstatus', array( 'unpaid', 'Unpaid', 'due' ) )->where('status', '=', 'Published')->whereRaw('order_due_date < DATE(NOW())')->count();
                           $purchase_orders_overdue_unpaid_amount = \App\Models\PurchaseOrder::where('currency_id', '=', $currency_id)->whereIn('paymentstatus', array( 'unpaid', 'Unpaid', 'due' ) )->where('status', '=', 'Published')->whereRaw('order_due_date < DATE(NOW())' )->sum('amount');
      ...
      <div class="row text-left quick-top-stats">
         <div class="col-lg-5ths col-md-5ths">
            <div class="row">
               ...
               <?php
                  $total_purchase_orders = \App\Models\PurchaseOrder::where('currency_id', '=', $currency_id)->count();
                  ?>
         ...
         <div class="col-lg-5ths col-md-5ths">
            <div class="row">
               ...
               <?php
                  $total_published_purchase_orders = \App\Models\PurchaseOrder::where('currency_id', '=', $currency_id)->where('status', '=', 'Published')->count();
                   $total_published_paid_purchase_orders = \App\Models\PurchaseOrder::where('currency_id', '=', $currency_id)->where('status', '=', 'Published')->where('paymentstatus', '=', 'paid')->count();
         ...
         <div class="col-lg-5ths col-md-5ths">
            <div class="row">
               ...
               <?php    
                  $total_published_unpaid_purchase_orders = \App\Models\PurchaseOrder::where('currency_id', '=', $currency_id)->whereIn('paymentstatus', array( 'unpaid', 'Unpaid', 'due' ) )->where('status', '=', 'Published')->whereRaw('order_due_date >= DATE(NOW())')->count();
                  if($total_published_purchase_orders){
