            ...
            <div class="crm-right-border-b1 crm-invoice-summaries-b1" onclick="summarypaymentstatus('paymentstatus', 'paid', 'circle', {{$currency_id}})">
               ...
               <div class="box-foot">
                  ...
                  <div class="box-foot-left pull-right">
                     @lang('others.statistics.paid') 
                     <?php
                        $total_paid_purchase_orders = \App\Models\PurchaseOrder::where('currency_id', '=', $currency_id)->where('status', '=', 'Published')->where('paymentstatus', '=', 'paid')->count();
            ...
            <div class="crm-right-border-b1 crm-invoice-summaries-b1" onclick="summarypaymentstatus('paymentstatus', 'unpaid', 'circle')">
               ...
               <div class="box-foot">
                  ...
                  <div class="box-foot-left pull-right">
                     @lang('others.statistics.unpaid')
                     <?php
                        $total_unpaid_purchase_orders = \App\Models\PurchaseOrder::where('currency_id', '=', $currency_id)->whereIn('paymentstatus', array( 'unpaid', 'Unpaid', 'due' ) )->where('status', '=', 'Published')->whereRaw('order_due_date >= DATE(NOW())')->count();
