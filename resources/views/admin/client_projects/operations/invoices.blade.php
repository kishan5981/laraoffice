    ...
    <p>
        <ul class="list-inline">
            ...
            @if( isAdmin() || isProjectManager() || isExecutive())
               {{\App\Models\Invoice::where('project_id', '=', $project->id)->count()}}
            @else
                {{\App\Models\Invoice::where('project_id', '=', $project->id)->where('customer_id', '=', getContactId())->count()}}
            @endif
            </span>
            </a></li>
            @if ( isAdmin() )
            ...
            <span class="badge"> 
            @if( isAdmin() )
               {{\App\Models\Invoice::where('project_id', '=', $project->id)->onlyTrashed()->count()}}
            @else
            {{\App\Models\Invoice::where('project_id', '=', $project->id)->onlyTrashed()->where('customer_id', '=', getContactId())->count()}}
            @endif
            </span>
            </a></li>
            @endif
