...
<div class="row">
	...
	<?php
	$projectObj = new \App\Models\ClientProject();
	...
	<div class="row" >
	   <div class="col-md-12 project-overview-expenses-finance">
	      <div class="col-md-3 logged-time-sec" style="border:1px solid lightgray; border-radius: 3px;height:130px;">
	         ...
	         <?php
	         $sum = \App\Models\Expense::where('project_id', $project->id)->sum('amount');
	         ?>
	      ...
	      <div class="col-md-3 logged-time-sec"  style="border:1px solid lightgray; border-radius: 3px;height:130px;">
	         ...
	         <?php
	         $sum = \App\Models\Expense::where('project_id', $project->id)->where('billable', 'yes')->sum('amount');
	         ?>
	         <p class="bold font-medium">{{digiCurrency($sum, $currency_id)}}</p>
	      </div>
	      <div class="col-md-3 logged-time-sec"  style="border:1px solid lightgray;border-radius: 3px; height:130px;">
	         ...
	         <?php
	         $sum = \App\Models\Expense::where('project_id', $project->id)->where('billable', 'yes')->where('billed', 'yes')->sum('amount');
	         ?>
	         <p class="bold font-medium">{{digiCurrency($sum, $currency_id)}}</p>
	      </div>
	      <div class="col-md-3 logged-time-sec"  style="border:1px solid lightgray; border-radius: 3px; height:130px;">
	         ...
	         <?php
	         $sum = \App\Models\Expense::where('project_id', $project->id)->where('billable', 'yes')->where('billed', 'no')->sum('amount');
	         ?>
	         <p class="bold font-medium">{{digiCurrency($sum, $currency_id)}}</p>
	      </div>
	   </div>
