                ...
                <div id="invoices_total">
                    ...
                    <div class="col-lg-3 total-column">
                            <div class="panel_s">
                              ...
                              <?php
	                           	  $total_amount_client_projects = App\Models\ClientProject::sum('budget');
	                           ?>
                        ...
                        <div class="col-lg-3 total-column">
                            ...
                            <?php
	                           $total_amount_high_priority_client_projects = App\Models\ClientProject::where('priority','=','High')->sum('budget');
	                          ?>
                        ...
                        <div class="col-lg-3 total-column">
                            <div class="panel_s">
                                <div class="panel-body-dr">
                          <?php
	                           $total_amount_urgent_client_projects = App\Models\ClientProject::where('priority','=','Urgent')->sum('budget');
	                         ?>
                        ...
                        <div class="col-lg-3 total-column">
                            <div class="panel_s">
                                <div class="panel-body-dr">
                              <?php
	                           $total_amount_medium_client_projects = App\Models\ClientProject::where('priority','=','Medium')->sum('budget');
	                           ?>
                                    <h3 class="text-muted _total">
                ...
                <div class="panel-body-dr">
                    <div class="row text-left quick-top-stats">
                        <div class="col-lg-5ths col-md-5ths">
                          ...
                          <?php
                           $total_client_projects = App\Models\ClientProject::count();
                           ?>
                        ...
                        <?php
                           $total_high_priority_client_projects = App\Models\ClientProject::where('priority','=','High')->count();
                           ?>
                       ...
                       <?php
                           $total_urgent_priority_client_projects = App\Models\ClientProject::where('priority','=','Urgent')->count();
                         ?>
                    ...
                    <div class="col-lg-5ths col-md-5ths">
                        ...
                        <?php
                           $total_medium_priority_client_projects = App\Models\ClientProject::where('priority','=','Medium')->count();
                         ?>
               ...
               <div class="col-md-12">
                   ...
                   <div class="crm-right-border-b1 crm-invoice-summaries-b1">
                    ...
                    <div class="crm-right-border-b1 crm-invoice-summaries-b1">
                       ...
                       <div class="box-content">
                           <?php
                           $total_urgent_client_projects = App\Models\ClientProject::where('priority','=','Urgent')->count();
                           ?>
                           <div class="sentTotal">
                    ...
                    <div class="crm-right-border-b1 crm-invoice-summaries-b1">
                       ...
                       <div class="box-content">
                           <?php
                           $total_medium_client_projects = App\Models\ClientProject::where('priority','=','Medium')->count();
                           ?>
                           <div class="sentTotal">
