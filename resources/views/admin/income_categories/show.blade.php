...
<li role="presentation" class="{{$tabs['income_active']}}"><a href="{{route('admin.income_categories.show', [ 'id' => $income_category->id, 'list' => 'income' ])}}" title= "@lang('global.income.title')">@lang('global.income.title')</a></li>
</ul>
