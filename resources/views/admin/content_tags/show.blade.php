...
<li role="presentation" class="{{$tabs['content_pages_active']}}"><a href="{{route('admin.content_tags.show', [ 'id' => $content_tag->id, 'list' => 'content_pages' ])}}" title="@lang('others.canvas.pages')">@lang('others.canvas.pages')</a></li>
<li role="presentation" class="{{$tabs['articles_active']}}"><a href="{{route('admin.content_tags.show', [ 'id' => $content_tag->id, 'list' => 'articles' ])}}" title="@lang('global.articles.title')">@lang('global.articles.title')</a></li>
</ul>
