      ...
      <div class="col-md-12">
       ...
       <div style="border-top-left-radius: 10px;" class="crm-right-border-b1 crm-invoice-summaries-b1 crm-invoice-summaries-b5" onclick="summarypaymentstatus('all', 'all', 'circle', {{$currency_id}})">
           ...
           <div class="box-content">
               <?php
               $total_invoices = \App\Models\CreditNote::where('currency_id', '=', $currency_id)->count();
               ?>
               <div class="sentTotal">
           ...
           <div class="box-foot">
               <div class="sendTime box-foot-left">
                   ...
                   <br>
                   <?php
                   $total_amount_invoices = \App\Models\CreditNote::where('currency_id', '=', $currency_id)->sum('amount');
                   ?>
      ...
      <div class="col-md-4">
       <div class="crm-right-border-b1 crm-invoice-summaries-b1 crm-invoice-summaries-b5" onclick="summarypaymentstatus('paymentstatus', 'closedbottom', 'circle', {{$currency_id}})">
           ...
           <div class="box-content invoice-percent" data-target="100" >
               <?php
               $total_published_invoices = \App\Models\CreditNote::where('currency_id', '=', $currency_id)->where('status', '=', 'Published')->count();
               $total_published_paid_invoices = \App\Models\CreditNote::where('currency_id', '=', $currency_id)->where('status', '=', 'Published')->whereIn('paymentstatus', array( 'paid','Paid' ) )->where('credit_status', '=' , 'Closed')->count();
           ...
           <div class="box-foot">
               ...
               <div class="box-foot-left">
                   ...
                   $total_paid_invoices = \App\Models\CreditNote::where('currency_id', '=', $currency_id)->where('status', '=', 'Published')->whereIn('paymentstatus', array( 'paid','Paid' ) )->where('credit_status', '=' , 'Closed')->sum('amount');
                   ?>
                   <br>
                   <span class="box-foot-stats">
                       <strong>
                 ...
                 $total_paid_invoices =\App\Models\CreditNote::where('currency_id', '=', $currency_id)->where('status', '=', 'Published')->whereIn('paymentstatus', array( 'paid','Paid' ) )->where('credit_status', '=' , 'Closed')->count();
      ...
      <div class="col-md-4">
         <div class="crm-right-border-b1 crm-invoice-summaries-b1 crm-invoice-summaries-b5" onclick="summarypaymentstatus('paymentstatus', 'openbottom', 'circle', {{$currency_id}})">
           ...
           <div class="box-content invoice-percent-3" data-target="100" style="width: 130px; height: 130px;">
               ...
               $total_published_unpaid_invoices = \App\Models\CreditNote::where('currency_id', '=', $currency_id)->where('status', '=', 'Published')->where('credit_status', '=' , 'Open')->count();
           ...
           <div class="box-foot">
               ...
               <div class="box-foot-left">
                   ...
                   $total_unpaid_invoices_amount = \App\Models\CreditNote::where('currency_id', '=', $currency_id)->where('status', '=', 'Published')->whereIn('paymentstatus', array( 'unpaid','partial' ) )->where('credit_status', '=' , 'Open')->sum('amount');
