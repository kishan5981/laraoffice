              ...
              <div class="col-lg-4 total-column">
                <div class="panel_s">
                  ...
                  <?php
                    ...
                    $invoice_unpaid_amount =  \App\Models\CreditNote::where('currency_id', '=', $currency_id)->where('status', '=', 'Published')->whereIn('paymentstatus', array( 'unpaid','partial' ) )->where('credit_status', '=' , 'Open')->sum('amount');
