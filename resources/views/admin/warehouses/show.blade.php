...
<li role="presentation" class="{{$tabs['products_active']}}"><a href="{{route('admin.warehouses.show',[ 
$warehouse->id,'list'=>'products'])}}" title= "@lang('others.canvas.products')">@lang('others.canvas.products')</a></li>
@endif
@if( isPluginActive('purchase_order') )
<li role="presentation" class="{{$tabs['purchase_orders_active']}}"><a href="{{route('admin.warehouses.show', [  $warehouse->id,'list'=>'purchase_orders'])}}">@lang('global.purchase-orders.title')</a></li>
@endif
