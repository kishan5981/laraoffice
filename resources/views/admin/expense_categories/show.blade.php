...
<li role="presentation" class="{{$tabs['expense_active']}}"><a href="{{route('admin.expense_categories.show', [ 'id' => $expense_category->id, 'list' => 'expense' ])}}" title= "@lang('global.expense.title')">@lang('global.expense.title')</a></li>
</ul>
