...
<li role="presentation" class="{{$tabs['assets_active']}}"><a href="{{route('admin.assets_categories.show', [ 'id' => $assets_category->id, 'list' => 'assets' ])}}" title= "@lang('global.assets.title')">@lang('global.assets.title')</a></li>
</ul>
