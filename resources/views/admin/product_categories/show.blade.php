...
<li role="presentation" class="{{$tabs['products_active']}}"><a href="{{route('admin.product_categories.show', [ 'id' => $product_category->id, 'list' => 'products' ])}}" title= "@lang('others.canvas.products')" >@lang('others.canvas.products')</a></li>
</ul>
