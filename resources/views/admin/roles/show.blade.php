...
<li role="presentation" class="{{$tabs['users_active']}}"><a href="{{route('admin.roles.show', [ 'id' => $role->id, 'list' => 'users' ])}}" title= "@lang('global.users.title')">@lang('global.users.title')</a></li>
