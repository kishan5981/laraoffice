...
<!-- <div class="col-lg-12">
        <ol class="breadcrumb">
            <li><a href="{{PREFIX}}">@lang('global.project-discussions.title')</a></li>
            <li>List</li>
        </ol>
    </div> -->
    ...
    <p>
        <ul class="list-inline">
            ...
            <span class="badge">            
            {{\App\Models\ProjectDiscussion::where('project_id', $project->id)->count()}}           
            </span>
            </a></li> 
            ...
            <span class="badge">            
            {{\App\Models\ProjectDiscussion::onlyTrashed()->where('project_id', $project->id)->count()}}           
            </span>
            </a></li>
            @endcan
        </ul>
