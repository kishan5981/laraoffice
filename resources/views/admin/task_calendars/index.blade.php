...
@section('content')
    ...
    <link href="{{ asset('css/cdn-styles-css/calendar/3.1.0/fullcalendar.min.css') }}" rel="stylesheet">  
...
@section('javascript')
    ...
    <script src="{{ asset('js/cdn-js-files/calendar/3.1.0') }}/fullcalendar.min.js"></script>
