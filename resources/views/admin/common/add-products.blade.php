...
<table class="table-responsive order_products">
    ...
    <tr class="item_header bg-gradient-directional-pink white text-view">
        <th  class="text-center">{{ trans('custom.products.item_name') }}</th>
        <th class="text-center">{{ trans('custom.products.quantity') }}</th>
        <th class="text-center">{{ trans('custom.products.rate') }}</th>
        <th class="text-center">{{ trans('custom.products.tax_percent') }}</th>
        <th class="text-center">{{ trans('custom.products.tax') }}</th>
        <th class="text-center">{{ trans('custom.products.discount_percent') }}</th>
        <th  class="text-center">{{ trans('custom.products.discount') }}</th>
        <th  class="text-center">{{ trans('custom.products.amount') }}</th>
        ...
        @else
        <th  class="text-center">{{ trans('custom.products.action') }}</th>
        @endif
    </tr>
    </thead>
    <tbody>
    ...
    <tr height="90px" class="product_row" data-rowid="{{$i}}" data-product_id="{{$pid}}" id="product_row_{{$i}}">
        ...
        <td valign="top">
            ...
            <select name="tax_type[]" id="tax_type-{{$i}}" onchange="rowTotal('{{$i}}')" style="padding: 7px 12px;">
                <
        ...
        <td valign="top">
            ...
            <select name="discount_type[]" id="discount_type-{{$i}}" onchange="rowTotal('{{$i}}')" style="padding: 7px 12px;">
    ...
    <tr class="sub_c" style="display: table-row;">
        <td colspan="7" align="right"><strong>@lang('custom.products.total_tax')</strong>
        </td>
    ...
    <tr class="sub_c" style="display: table-row;">
        <td colspan="7" align="right"><strong>@lang('custom.products.sub_total')</strong>
        </td>
        <td align="left" colspan="1" class="text-right">
    ...
    <tr class="sub_c" style="display: table-row;">
        <!-- <td colspan="2">&nbsp;</td> -->
        <td colspan="7" align="right"><strong> @lang('custom.products.grand_total')</strong>
        </td>
        <td class="text-right" colspan="1">
