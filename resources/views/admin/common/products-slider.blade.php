...
<div class="prod-div">
    ...
    <style>
       /*jssor slider loading skin spin css*/
        ...
        .slides{
            cursor:default;position:relative;top:0px;left:0px;width:980px;height:100px;overflow:hidden;
        }
    </style>
    <div id="jssor_1">
        <!-- Loading Screen -->
        ...
        <div data-u="navigator" class="jssorb031"  data-autocenter="1" data-scale="0.5" data-scale-bottom="0.75">
            <div data-u="prototype" class="i">
                <svg viewBox="0 0 16000 16000" class="svg-style">
        ...
        <style>
            .jssora051 {display:block;position:absolute;cursor:pointer;width:55px;height:55px;top:0px;left:25px;}
