...
<li role="presentation" class="{{$tabs['assets_history_active']}}"><a href="{{route('admin.assets_statuses.show', [ 'id' => $assets_status->id, 'list' => 'assets_history' ])}}" title= "@lang('global.assets-history.title')">@lang('global.assets-history.title')</a></li>
<li role="presentation" class="{{$tabs['assets_active']}}"><a href="{{route('admin.assets_statuses.show', [ 'id' => $assets_status->id, 'list' => 'assets' ])}}" title= "@lang('global.assets.title')">@lang('global.assets.title')</a></li>
</ul>
