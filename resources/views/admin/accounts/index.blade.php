                ...
                <thead>
                    <tr>
                        @can('account_delete_multi')
                            @if ( request('show_deleted') != 1 )<th class="text-align:center;"><input type="checkbox" id="select-all" /></th>@endif
                        @endcan
