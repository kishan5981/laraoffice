    ...
    <button type="submit" class="btn btn-login float-right">@lang('global.app_login')</button>
        ...
        <div class="col-sm-6">
          ...
          ?>
               ...
               <li class="sideby"><a href="{{ route('direct.login', $role->id) }}" class="positive">{{$role->title}}&nbsp;{!!digi_get_help($role->description)!!}</a></li>
        
          <?php
          }
          ?>
          <li class="sideby"><a class="positive" href="https://laraofficedocumentation.digisamaritan.com/" target="_blank" style="padding-bottom: -5px;">Documentation</a></li>
          </ul>
