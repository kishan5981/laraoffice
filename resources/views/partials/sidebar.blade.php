    ...
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            @endif
                ...
                <li class="Lo-left-sidebar header-dashboard {{ $request->segment(1) == 'home' ? 'active' : '' }}">
                ...
                <li class="treeview Lo-left-sidebar">
                    ...
                    <ul class="treeview-menu">
                        ...
                        @if( File::exists(config('modules.paths.modules') .
                ...
                <li class="header Lo-header">@lang('custom.menu.stock')</li>
                <li class="treeview Lo-left-sidebar">
                    <a href="#">
                ...
                @can('contact_access')
                <li class="header Lo-header">@lang('custom.menu.crm')</li>
                <li class="treeview Lo-left-sidebar">
                    <a href="#">
                ...
                @can('project_access')
                <li class="header Lo-header">@lang('custom.menu.project')</li>
                <li class="treeview Lo-left-sidebar">
                    <a href="#">
                ...
                <li class="header Lo-header">@lang('custom.menu.balance')</li>
                <li class="treeview Lo-left-sidebar">
                    <a href="#">
                ...
                <li class="header Lo-header">@lang('custom.menu.miscellaneous')</li>
                ...
                <li
                    class="treeview Lo-left-sidebar {{ ( in_array( $request->segment(1), array( 'internal_notifications' ) ) || ( in_array($controller, array('SendSmsController') ) && in_array($action, array('index', 'create', 'edit', 'show', 'destroy') ) ) ) ? 'active' : '' }}">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        ...
                        @can('send_sm_access')
                        <li
                            class="{{ ( in_array($controller, array('SendSmsController') ) && in_array($action, array('index', 'create', 'edit', 'show', 'destroy') ) ) ? 'active' : '' }}">
                ...
                <li
                    class="treeview Lo-left-sidebar {{ ( in_array( $request->segment(1), array( 'support' ) ) || in_array( $request->segment(2), array(  'articles', 'faq_questions', 'faq_categories' ) ) ) ? 'active' : '' }}">
                    <a href="#">
                        <i class="fa fa-building-o"></i>
                ...
                <li class="treeview Lo-left-sidebar">
                    ...
                    <ul class="treeview-menu">
                        ...
                        @can('language_access')
                        <li
                            class="{{ ( in_array($controller, array('LanguagesController') ) && in_array($action, array('index', 'create', 'edit', 'show', 'destroy') ) ) ? 'active' : '' }}">
                        ...
                        {{--
                        @if( File::exists(config('modules.paths.modules') .
                        '/SiteThemes') && Module::find('sitethemes') &&
                ...
                @can('reports_access')
                <li class=" Lo-left-sidebar {{ ( in_array($controller, array('ReportsController') ) ) ? 'active' : '' }}">
                    <a href="#">
                        <i class="fa fa-line-chart"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li
                            class="{{ ( in_array($controller, array('ReportsController') ) && in_array($action, array('incomeReport') ) ) ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ ( in_array($controller, array('ReportsController') ) && in_array($action, array('expenseReport') ) ) ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ ( in_array($controller, array('ReportsController') ) && in_array($action, array('usersReport') ) ) ? 'active' : '' }}">
                        ...
                        @can('reports_users_access')
                        <li
                            class="{{ ( in_array($controller, array('ReportsController') ) && in_array($action, array('rolesUsersReport') ) ) ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ ( in_array($controller, array('ReportsController') ) && in_array($action, array('contactsProjectsReports') ) ) ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ ( in_array($controller, array('ReportsController') ) && in_array($action, array('tasksReport') ) ) ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ ( in_array($controller, array('ReportsController') ) && in_array($action, array('assetsReport') ) ) ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ ( in_array($controller, array('ReportsController') ) && in_array($action, array('productsReport') ) ) ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ ( in_array($controller, array('ReportsController') ) && in_array($action, array('purchaseOrdersReport') ) ) ? 'active' : '' }}">
                ...
                <li
                    class=" Lo-left-sidebar {{ ( in_array($controller, array('ModulesManagementsController') ) && in_array($action, array('index', 'create', 'edit', 'show') ) ) ? 'active' : '' }}">
                ...
                <li
                    class=" Lo-left-sidebar {{ $request->segment(2) == 'messenger' ? 'active' : '' }} {{ ($unread > 0 ? 'unread' : '') }}">
                ...
                <li class=" Lo-left-sidebar {{ $request->segment(1) == 'change_password' ? 'active' : '' }}">
