...
use Modules\Support\Traits\ContentEllipse;
use Modules\Support\Traits\Purifiable;
...
class Ticket extends Model
{
    ...
    {
        return $this->belongsTo('Modules\Support\Entities\Status', 'status_id');
    }
    ...
    {
        return $this->belongsTo('Modules\Support\Entities\Priority', 'priority_id');
    }
    ...
    {
        return $this->belongsTo('Modules\Support\Entities\Category', 'category_id');
    }
    ...
    {
        return $this->belongsTo('Modules\Support\Entities\Agent', 'agent_id');
    }
    ...
    {
        return $this->hasMany('Modules\Support\Entities\Comment', 'ticket_id');
    }
