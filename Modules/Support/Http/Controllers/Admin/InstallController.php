...
use Modules\Support\Seeds\SettingsTableSeeder;
use Modules\Support\Seeds\TicketitTableSeeder;
...
class InstallController extends Controller
{
    ...
    public function publicAssets()
    {
        ...
        if ($public !== $assets) {
            Artisan::call('vendor:publish', [
                '--provider' => 'Modules\\Support\\Providers\\SupportServiceProvider',
                '--tag'      => ['public'],
            ]);
        }
    }
    ...
    public function index()
    {
        ...
        if (count($this->migrations_tables) == count($this->inactiveMigrations())
            ...
            $views_files_list = $this->viewsFilesList(resource_path('views')) + ['another' => trans('support::install.another-file')];
            ...
            return view('support::install.index', compact('views_files_list', 'inactive_migrations', 'users_list'));
        }
        ...
        if (Agent::isAdmin()) {
            ...
            return view('support::install.upgrade', compact('inactive_migrations', 'inactive_settings'));
        }
