...
class PrioritiesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('support::admin.priority.index', compact('priorities'));
    }
    ...
    {
        return view('support::admin.priority.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        \Cache::forget('support::priorities');
    ...
    {
        return trans('support::lang.priority-all-tickets-here');
    }
    ...
    public function edit($id)
    {
        ...
        return view('support::admin.priority.edit', compact('priority'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash('status', trans('Updated Successfully', ['name' => $request->name]));
