...
$factory->define(Modules\RecurringInvoices\Entities\RecurringInvoice::class, function (Faker\Generator $faker) {
    return [
        "customer_id" => factory('App\Models\Contact')->create(),
        "currency_id" => factory('App\Models\Currency')->create(),
        "title" => $faker->name,
        "address" => $faker->name,
        ...
        "tax_id" => factory('App\Models\Tax')->create(),
        "discount_id" => factory('App\Models\Discount')->create(),
