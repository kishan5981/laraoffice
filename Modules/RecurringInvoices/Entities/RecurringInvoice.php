...
class RecurringInvoice extends Model implements HasMedia
{
    ...
    public function getInvoiceNumberDisplayAttribute($input)
   {
    ...
    {
        return $this->belongsTo(\App\Models\Contact::class, 'customer_id');
    }
    ...
    {
        return $this->belongsToMany(\App\Models\PaymentGateway::class, 'invoice_paymentmodes', 'invoice_id')->withTrashed();
    }
