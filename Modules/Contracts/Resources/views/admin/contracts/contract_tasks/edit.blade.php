...
@section('content')
    ...
    {!! Form::model($contract_task, ['method' => 'PUT', 'route' => ['admin.contract_tasks.update', $contract_task->contract_id, $contract_task->id],'class'=>'formvalidation']) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
             @include('contracts::admin.contracts.contract_tasks.form-fields', compact('contract_task'))            
        </div>
    </div>
...
@section('javascript')
   ...
   <script>
    ...
    <script>
            ...
            $(document).on('click', '#selectbtn-assigned_to', function() {
            $("#selectall-assigned_to > option").prop("selected","selected");
            $("#selectall-assigned_to").trigger("change");
        });
       
            $(document).on('click', '#deselectbtn-assigned_to', function() {
