...
class InvoiceTasksController extends Controller
{
    ...
    public function create( $invoice_id )
    {
        ...
        $invoices = \App\Models\Invoice::get()->pluck('title', 'id')->prepend(trans('global.app_please_select'), '');
        $created_bies = \App\Models\User::get()->pluck('name', 'id')->prepend(trans('global.app_please_select'), '');
        $mile_stones = \App\Models\MileStone::get()->pluck('name', 'id')->prepend(trans('global.app_please_select'), '');
     ...
     *
     * @param  \App\Models\Http\Requests\StoreInvoiceTasksRequest  $request
     * @return \Illuminate\Http\Response
     */
     ...
     *
     * @param  \App\Models\Http\Requests\UpdateInvoiceTasksRequest  $request
     * @param  int  $id
     * @return \Illuminate\Http\Response
     */
