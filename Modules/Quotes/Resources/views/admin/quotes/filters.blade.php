    ...
    <div class="panel-body">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group filter-group">
                <label for="name">@lang('others.statistics.date')</label><br>
                ...
                <div class="col-md-2">
            <div class="form-group filter-group">
                <label for="email">@lang('others.statistics.type')</label><br>
                <?php
                $date_types = array(
                ...
                <div class="col-md-2">
            <div class="form-group filter-group">
                <label for="email">@lang('others.statistics.payment')</label><br>
                <?php
                ...
                <div class="col-md-2">
            <div class="form-group filter-group">
                <label for="email">@lang('global.invoices.fields.currency')</label><br>
                <?php
                ...
                <div class="col-md-2">
            <div class="form-group filter-group">
                <label for="email">@lang('others.statistics.customer')</label><br>
                 <?php   
