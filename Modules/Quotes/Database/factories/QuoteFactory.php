...
$factory->define(Modules\Quotes\Entities\Quote::class, function (Faker\Generator $faker) {
      $data = [
        ...
        'customer_id' => function () {
                    return App\Models\Contact::inRandomOrder()->whereHas("contact_type",
                    function ($query) {
                    $query->where('id', CUSTOMERS_TYPE);
                    })->first()->id;
        },
        'currency_id' => function () {
            return App\Models\Currency::inRandomOrder()->first()->id;
        },
        'tax_id' => function () {
                  return App\Models\Tax::inRandomOrder()->first()->id;
        },
