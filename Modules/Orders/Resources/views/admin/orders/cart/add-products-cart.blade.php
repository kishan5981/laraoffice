...
<div class="col-md-12">
   ...
   <div class="col-md-6">
      ...
      <?php
        ...
        ?>
               ...
               <?php
               $products = \App\Models\Product::where('product_status', 'Active')->where('stock_quantity', '>', 0)->where('prices_available', 'like', "%$currency_code%")->paginate(9);
               ?>
   ...
   <div class="col-md-6">
      ...
      @include('orders::admin.orders.cart.cart')
   </div>
...
@include('orders::admin.orders.cart.modal-loading')
@section('javascript')
@parent
...
<script type="text/javascript">
   ...
   /*new js addtoquick cart*/
    ...
    $(document).on('click', '.addToCartQuickBtn', function() {
   var product_id = $(this).data('product_id');
   var quantity = 1;
   var stock_quantity = $(this).data('stock_quantity');
