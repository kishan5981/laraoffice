...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Eventy::addAction('master_settings.destroy', function($id) {
            ...
            $master_setting = \App\Models\MasterSetting::withTrashed()->find($id);
        ...
        Eventy::addAction('master_settings.massdestroy', function($request) {
            $entries = \App\Models\MasterSetting::whereIn('id', $request->input('ids'))->withTrashed()->get();
            if ( $entries ) {
    ...
    public function updateSmsGateways() {
        $sms_gateways = \App\Models\Settings::where('moduletype', 'sms')->get()->pluck('module', 'key');
