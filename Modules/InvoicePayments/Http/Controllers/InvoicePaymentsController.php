...
class InvoicePaymentsController extends Controller
{
    ...
    public function create()
    {
        ...
        $invoices = \App\Models\Invoice::get()->pluck('invoice_no', 'id')->prepend(trans('global.app_please_select'), '');
     ...
     *
     * @param  \App\Models\Http\Requests\StoreInvoicePaymentsRequest  $request
     * @return \Illuminate\Http\Response
     */
     ...
     *
     * @param  \App\Models\Http\Requests\UpdateInvoicePaymentsRequest  $request
     * @param  int  $id
     * @return \Illuminate\Http\Response
     */
