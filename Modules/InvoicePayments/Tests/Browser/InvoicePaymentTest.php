...
class InvoicePaymentTest extends DuskTestCase
{
    ...
    public function testCreateInvoicePayment()
    {
        ...
        $invoice_payment = factory('App\Models\InvoicePayment')->make();
    ...
    {
        $admin = factory('App\Models\User', 'admin')->create();
        $invoice_payment = factory('App\Models\InvoicePayment')->create();
        $invoice_payment2 = factory('App\Models\InvoicePayment')->make();
