        ...
        <div class="title-action">
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu">
                ...
                ?>
                <li><a href="#loadingModal" data-toggle="modal" data-remote="false" class="dropdown-item sendBill" data-action="proposal-created-ema" data-invoice_id="{{$invoice->id}}">{{trans('proposals::custom.proposals.proposal-created')}}@if( $is_sent ) (@lang('custom.messages.sent')) @endif</a></li>
                @endcan
              </ul>
            </div>
            @endif
