    ...
    public function index()
    {
        ...
        if (! Gate::allows('account_delete')) {
            ...
            $table->editColumn('initial_balance', function ($row) {
                ...
                $total_in  = \App\Models\Income::where('account_id', $row->id)->sum('amount');
                $total_out = \App\Models\Expense::where('account_id', $row->id)->sum('amount');
            ...
            $table->rawColumns(['actions','massDelete','initial_balance','name']);
