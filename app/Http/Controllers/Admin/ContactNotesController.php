...
class ContactNotesController extends Controller
{
    ...
    public function index( $contact_id = '' )
    {
        ...
        if (! Gate::allows('contact_note_delete')) {
            ...
            $table->rawColumns(['actions','massDelete','attachment', 'contact.first_name','title']);
    ...
    public function create()
    {
        ...
        $contacts = \App\Models\Contact::get()->pluck('name', 'id')->prepend(trans('global.app_please_select'), '');
