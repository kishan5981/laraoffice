...
class AssetsController extends Controller
{
    ...
    public function create()
    {
        ...
        $categories = \App\Models\AssetsCategory::get()->pluck('title', 'id')->prepend(trans('global.app_please_select'), '');
        $statuses = \App\Models\AssetsStatus::get()->pluck('title', 'id')->prepend(trans('global.app_please_select'), '');
        $locations = \App\Models\AssetsLocation::get()->pluck('title', 'id')->prepend(trans('global.app_please_select'), '');
        $assigned_users = \App\Models\User::get()->pluck('name', 'id')->prepend(trans('global.app_please_select'), '');
    ...
    public function show($id, $list = '')
    {
        ...
        $locations = \App\Models\AssetsLocation::get()->pluck('title', 'id')->prepend(trans('global.app_please_select'), '');
        $assigned_users = \App\Models\User::get()->pluck('name', 'id')->prepend(trans('global.app_please_select'), '');
        $assets_histories = \App\Models\AssetsHistory::where('asset_id', $id)->get();
