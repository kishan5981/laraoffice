...
class LeadsController extends Controller
{
    ...
    public function create()
    {
        ...
        $contact_types = \App\Models\ContactType::get()->pluck('name', 'id');
    ...
    public function show($id)
    {
        ...
        $countries = \App\Models\Country::get()->pluck('title', 'id')->prepend(trans('global.app_please_select'), '');
        $invoices = \App\Models\Invoice::where('customer_id', $id)->get();
        ...
        $purchase_orders = \App\Models\PurchaseOrder::where('customer_id', $id)->get();
        $contact_notes = \App\Models\ContactNote::where('contact_id', $id)->get();
        $products_returns = \App\Models\ProductsReturn::where('customer_id', $id)->get();
        $client_projects = \App\Models\ClientProject::where('client_id', $id)->get();
        $contact_documents = \App\Models\ContactDocument::where('contact_id', $id)->get();
        $users = \App\Models\User::where('contact_reference_id', $id)->get();
        $incomes = \App\Models\Income::where('payer_id', $id)->get();
        $expenses = \App\Models\Expense::where('payee_id', $id)->get();
