...
class ContentPagesController extends Controller
{
    ...
    public function index( $type = '', $type_id = '',$catid = 0  )
    {
        ...
        if (request()->ajax()) {
            ...
            $table->rawColumns(['title', 'actions','massDelete','category_id.title','tag_id.title','featured_image', 'page_text','title']);
    ...
    public function show($id , $list='')
    {
        ...
        return view('admin.content_pages.show', compact('content_page','list'));
    }
