...
class ProductsController extends Controller
{
    ...
    public function index($type = '', $type_id = '')
    {
        ...
        if (request()->ajax()) {
            ...
            */
            ...
            $table->rawColumns(['actions','massDelete','category.name','image_gallery','thumbnail','other_files', 'stock_quantity','product_code','products.name']);
     ...
     *
     * @param  \App\Models\Http\Requests\StoreProductsRequest  $request
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request)
    {
        ...
        if ( ! empty( $prices['actual'] ) ) {
            foreach ($prices['actual'] as $key => $value) {
                ...
                $currency_id = null;
                $details = \App\Models\Currency::where('code', $key)->first();
                if ( $details ) {
