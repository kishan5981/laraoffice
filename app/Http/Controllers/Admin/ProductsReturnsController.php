...
class ProductsReturnsController extends Controller
{
    ...
    public function create()
    {
        ...
        $customers = \App\Models\Contact::get()->pluck('first_name', 'id')->prepend(trans('global.app_please_select'), '');
     ...
     *
     * @param  \App\Models\Http\Requests\StoreProductsReturnsRequest  $request
     * @return \Illuminate\Http\Response
     */
     ...
     *
     * @param  \App\Models\Http\Requests\UpdateProductsReturnsRequest  $request
     * @param  int  $id
     * @return \Illuminate\Http\Response
     */
    ...
    {      
        ...
        switch ( $type ) {
            ...
            case 'customer':
                    ...
                    $customer = \App\Models\Contact::where( 'id', $customer_id)->first();
                    if ( ! empty( $customer ) ) {
						...
						$display_currency = \App\Models\Settings::getSetting('display_currency', 'currency_settings');
            ...
            case 'task_details':
                if ($request->input('name_startsWith') || $request->input('product_id')) {
                    ...
                    foreach ($query->get() as $record ) {                       
                        ...
                        $task_id = $record->id;
                        $sec     = \App\Models\ProjectTask::taskTotalTime($task_id);
            ...
            case 'warehouse_products':
                ...
                if ($request->input('wid')) {
                    $products_collection = \App\Models\Product::where('ware_house_id', $request->input('wid'))->get();
                    
                    if ( ! empty( $products_collection ) ) {
                        foreach ($products_collection as $product) {
                            $warehouse = \App\Models\Warehouse::find( $product->ware_house_id );
                            if ( $warehouse ) {
                    ...
                    $products_collection = \App\Models\Product::get();
