...
class LoginController extends Controller
{
    ...
    */
    ...
    public function directLogin( MessageBag $message_bag, $id = '' )
    {
      ...
      $roles = \App\Models\ContactType::where('type', 'role')->where('status', 'active')->orderBy('priority')->get();
    ...
    function dueReminders() {
        ...
        $invoices = \App\Models\Invoice::whereBetween('due_date', [])->get();
