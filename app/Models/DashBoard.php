...
class DashBoard extends Model
{
    ...
    {
        return $this->belongsTo(\App\Models\Role::class, 'role_id')->withTrashed();
    }

    public function role_widgets()
    {
        return $this->belongsToMany(\App\Models\Role::class, 'dashboard_widgets_role', 'dash_board_id', 'role_id');
    }
