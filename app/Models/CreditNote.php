...
class CreditNote extends Model implements HasMedia
{
    ...
    {
        return $this->belongsToMany(\App\Models\PaymentGateway::class, 'credit_note_paymentmodes')->withTrashed();
    }
    ...
    {
        return \App\Models\CreditNotePayment::where('credit_note_id', $id)->sum('amount');
    }

    public function total_credits_used_by_credit_note( $id )
    {
        return \App\Models\CreditNoteCredit::where('credit_note_id', $id)->sum('amount');
    }
