...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('purchase_orders_payments', function (Blueprint $table) {
            $table->increments('id');
           ...
           $table->timestamp('created_at')->nullable()->default(NULL);
            ...
            $table->unsignedInteger('purchase_order_id')->nullable()->default(0)->index('263295_5c5d41a961b9c');
    ...
    {
        Schema::dropIfExists('purchase_orders_payments');
    }
};
