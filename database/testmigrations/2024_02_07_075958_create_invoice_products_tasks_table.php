...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('invoice_products_tasks', function (Blueprint $table) {
            $table->unsignedInteger('invoice_id')->nullable()->default(0)->index('fk_invoice_id_invoice_products22');
            $table->unsignedInteger('task_id')->nullable()->default(0)->index('fk_acrm_invoice_products_task_id_idx22');
            ...
            $table->unsignedInteger('time_entry_id')->nullable()->default(0)->index('fk_acrm_invoice_products_tasks_time_entry_id_idx');

            $table->index(['invoice_id'], 'fk_product_id_invoice_products22');
        });
    }
    ...
    {
        Schema::dropIfExists('invoice_products_tasks');
    }
};
