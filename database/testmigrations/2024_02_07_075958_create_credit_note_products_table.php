...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('credit_note_products', function (Blueprint $table) {
            $table->unsignedInteger('credit_note_id')->nullable()->default(0)->index('fk_credit_note_id_credit_note_products');
            $table->unsignedInteger('product_id')->nullable()->default(0)->index('fk_product_id_credit_note_products2');
            ...
            $table->index(['credit_note_id'], 'fk_product_id_credit_note_products');
        });
    }
