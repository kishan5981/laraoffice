...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('quote_products', function (Blueprint $table) {
            $table->unsignedInteger('quote_id')->nullable()->default(0)->index('fk_quote_id_quotee_products');
            $table->unsignedInteger('product_id')->nullable()->default(0)->index('fk_product_id_quote_products2');
            ...
            $table->index(['quote_id'], 'fk_product_id_quote_products');
        });
    }
