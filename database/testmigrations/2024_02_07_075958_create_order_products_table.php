...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('order_products', function (Blueprint $table) {
            $table->unsignedInteger('order_id')->nullable()->default(0)->index('fk_order_id_order_products');
            $table->unsignedInteger('product_id')->nullable()->default(0)->index('fk_product_id_order_products2');
            ...
            $table->index(['order_id'], 'fk_product_id_order_products');
        });
    }
