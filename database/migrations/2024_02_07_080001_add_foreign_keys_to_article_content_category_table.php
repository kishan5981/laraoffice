...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('article_content_category', function (Blueprint $table) {
            $table->foreign(['content_category_id'], 'fk_p_259301_259566_articl99_5c5036ef1e28b')->references(['id'])->on('content_categories')->onDelete('CASCADE');
    ...
    {
        Schema::table('article_content_category', function (Blueprint $table) {
            $table->dropForeign('fk_p_259301_259566_articl99_5c5036ef1e28b');
