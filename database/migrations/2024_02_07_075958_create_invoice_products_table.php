...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('invoice_products', function (Blueprint $table) {
            $table->unsignedInteger('invoice_id')->nullable()->default(0)->index('fk_invoice_id_invoice_products');
            $table->unsignedInteger('product_id')->nullable()->default(0)->index('fk_product_id_invoice_products2');
            ...
            $table->index(['invoice_id'], 'fk_product_id_invoice_products');
        });
    }
