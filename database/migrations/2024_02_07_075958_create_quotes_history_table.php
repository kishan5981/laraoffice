...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('quotes_history', function (Blueprint $table) {
            $table->increments('id');
           ...
           $table->timestamp('created_at')->nullable()->default(NULL);
            ...
            $table->unsignedInteger('quote_id')->nullable()->default(0)->index('259415_5c500ae99af17');
    ...
    {
        Schema::dropIfExists('quotes_history');
    }
};
