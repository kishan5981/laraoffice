...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('invoices', function (Blueprint $table) {
            ...
            $table->text('address')->nullable()->comment('Billing Address');
           ...
           $table->timestamp('created_at')->nullable()->default(NULL);
            ...
            $table->unsignedInteger('created_by_id')->nullable()->default(0)->index('fk_acrm_invoices_created_by_id_idx');
            ...
            $table->unsignedInteger('order_id')->nullable()->default(0)->index('fk_acrm_invoices_orderid_idx');
            $table->unsignedInteger('proposal_id')->nullable()->default(0)->index('fk_acrm_invoices_proposal_id_idx');
        });
    }
