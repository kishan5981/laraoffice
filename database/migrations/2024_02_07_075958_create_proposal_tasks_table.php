    ...
    public function up()
    {
        Schema::create('proposal_tasks', function (Blueprint $table) {
           ...
           $table->timestamp('created_at')->nullable()->default(NULL);
            ...
            $table->softDeletes()->default(NULL)->index('proposal_tasks_deleted_at_index');
            $table->unsignedInteger('recurring_id')->nullable()->default(0)->index('298242_5cc68c34c3153proposal');
            $table->unsignedInteger('proposal_id')->nullable()->default(0)->index('298242_5cc68c34eed43proposal');
            $table->unsignedInteger('created_by_id')->nullable()->default(0)->index('fk_acrm_proposal_tasks_created_by_id');
            $table->unsignedInteger('mile_stone_id')->nullable()->default(0);
            $table->unsignedInteger('is_recurring_from')->nullable()->default(0)->index('fk_is_recurring_from_proposal_tasks');
        });
    }
